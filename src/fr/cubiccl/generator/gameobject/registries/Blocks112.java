...
public final class Blocks112
{
	...
	public static final Block Dispenser = (Block) new BlockFacing(23, "dispenser").setTextureType(-1);
	public static final Block Sandstone = new Block(24, "sandstone");
	public static final Block NoteBlock = new Block(25, "noteblock");
	public static final Block Bed = (Block) new Block(26, "bed").setTextureType(-8);
	...
	public static final Block PistonSticky = (Block) new BlockFacing(29, "sticky_piston").setTextureType(-1);
	...
	public static final Block Piston = (Block) new BlockFacing(33, "piston").setTextureType(-1);
	...
	public static final Block PistonExtension = (Block) new BlockFacing(36, "piston_extension").setTextureType(-1);
	...
	public static final Block SlabStone = (Block) new Block(44, "stone_slab").setTextureType(8);
	public static final Block Brick = new Block(45, "brick_block");
	public static final Block TNT = (Block) new Block(46, "tnt").setTextureType(-1);
	...
	public static final Block Farmland = (Block) new Block(60, "farmland").setTextureType(-7);
	...
	public static final Block SignStanding = (Block) new Block(63, "standing_sign").setTextureType(-1);
	...
	public static final Block Lever = (Block) new Block(69, "lever").setTextureType(-1);
	public static final Block PressurePlateStone = (Block) new Block(70, "stone_pressure_plate").setTextureType(-1);
	public static final Block DoorIron = new BlockDoor(71, "iron_door");
	public static final Block PressurePlateOak = (Block) new Block(72, "wooden_pressure_plate").setTextureType(-1);
	...
	public static final Block RedstoneTorchOff = (Block) new Block(75, "unlit_redstone_torch").setTextureType(-1);
	public static final Block RedstoneTorch = (Block) new Block(76, "redstone_torch").setTextureType(-1);
	...
	public static final Block Jukebox = (Block) new Block(84, "jukebox").setTextureType(-1);
	public static final Block FenceOak = new Block(85, "fence");
	public static final Block Pumpkin = (Block) new Block(86, "pumpkin").setTextureType(-1);
	...
	public static final Block PortalNether = (Block) new Block(90, "portal").setTextureType(-1);
	public static final Block PumpkinLit = (Block) new Block(91, "lit_pumpkin").setTextureType(-1);
	...
	public static final Block MushroomBlockBrown = (Block) new Block(99, "brown_mushroom_block").setTextureType(-1);
	...
	public static final Block Vines = (Block) new Block(106, "vine").setTextureType(-1);
	...
	public static final Block NetherWart = (Block) new BlockNumbered(115, "nether_wart").setTextureType(0);
	...
	public static final Block Cauldron = (Block) new Block(118, "cauldron").setTextureType(-1);
	public static final Block PortalEnd = new Block(119, "end_portal");
	public static final Block PortalEndFrame = (Block) new Block(120, "end_portal_frame").setTextureType(-1);
	...
	public static final Block CocoaBeans = (Block) new Block(127, "cocoa").setTextureType(-4);
	...
	public static final Block TripwireHook = (Block) new Block(131, "tripwire_hook").setTextureType(-1);
	...
	public static final Block Carrots = (Block) new BlockNumbered(141, "carrots").setTextureType(0);
	public static final Block Potatoes = (Block) new BlockNumbered(142, "potatoes").setTextureType(0);
	public static final Block ButtonOak = new Block(143, "wooden_button");
	public static final Block Skull = (Block) new Block(144, "skull").setTextureType(-1);
	public static final Block Anvil = (Block) new Block(145, "anvil").setTextureType(-4);
	...
	public static final Block DaylightDetector = (Block) new Block(151, "daylight_detector").setTextureType(-1);
	...
	public static final Block Hopper = (Block) new Block(154, "hopper").setTextureType(-1);
	...
	public static final Block Dropper = (Block) new BlockFacing(158, "dropper").setTextureType(-1);
	...
	public static final Block FlowerDouble = (Block) new Block(175, "double_plant").setTextureType(8);
	public static final Block BannerStanding = (Block) new Block(176, "standing_banner").setTextureType(-1);
	public static final Block BannerWall = new BlockFurniture(177, "wall_banner");
	public static final Block DaylightDetectorInverted = (Block) new Block(178, "daylight_detector_inverted").setTextureType(-1);
	...
	public static final Block SlabStone2 = (Block) new Block(182, "stone_slab2").setTextureType(-1);
	...
	public static final Block ChorusFlower = (Block) new Block(200, "chorus_flower").setTextureType(-1);
	...
	public static final Block SlabPurpur = (Block) new Block(205, "purpur_slab").setTextureType(-1);
	public static final Block EndBricks = new Block(206, "end_bricks");
	public static final Block Beetroots = (Block) new BlockNumbered(207, "beetroots").setTextureType(0);
	...
	public static final Block Observer = (Block) new BlockFacing(218, "observer").setTextureType(-1);
